...
- [ ] All 29 sub-genre entries rewritten under the same contract. *(17 registered in `V2_UPGRADED_SUB_GENRES` gate table through 2026-04-23 — 12 remaining: `storytelling/mystery`, `storytelling/sci-fi`, `explainer-podcast/health`, `explainer-podcast/history`, `explainer-podcast/technology`, `skill-mastery/cooking-craft`, `skill-mastery/investing-personal-finance`, `skill-mastery/music-theory`, `corporate-training/data-privacy`, `corporate-training/dei`, `corporate-training/manager-onboarding`, `corporate-training/sales-enablement`. **exam-prep axis fully closed 6/6** via #582 + #583.)*
...
- *(next)* sub-genre v2 sweep — 12 entries remaining across skill-mastery (3) + explainer-podcast (3) + corporate-training (4) + storytelling (2). Owner priority suggests skill-mastery triple first.
