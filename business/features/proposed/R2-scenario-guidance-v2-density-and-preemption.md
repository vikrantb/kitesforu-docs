...
- [ ] All 29 sub-genre entries rewritten under the same contract. *(23 registered in `V2_UPGRADED_SUB_GENRES` gate table through 2026-04-24 — 6 remaining: `storytelling/mystery`, `storytelling/sci-fi`, `corporate-training/data-privacy`, `corporate-training/dei`, `corporate-training/manager-onboarding`, `corporate-training/sales-enablement`. **exam-prep 6/6** + **skill-mastery 5/5** + **explainer-podcast 6/6** axes fully closed.)*
...
- *(next)* sub-genre v2 sweep — 6 entries remaining: corporate-training (4 — data-privacy, dei, manager-onboarding, sales-enablement) + storytelling (2 — mystery, sci-fi). Corporate-training has a single shipped sibling (`cybersecurity`) to mirror; storytelling has 5 siblings (horror-folk, comedy, bedtime, romance, drama) to mirror.
